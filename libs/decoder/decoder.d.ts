...
declare module amf {
    ...
    class Request {
        ...
        token: any;
        holdQueue: any;
        constructor(source: any, operation: any, params: any, onResult: any, onStatus: any, token: any, holdQueue: any);
    }
    class Writer {
        data: any[];
        private objects;
        ...
        writeUTF: (v: any, asAmf: any) => any;
        writeUInt29: (v: any) => void;
        writeAll: (bytes: any) => void;
        writeBoolean: (v: any) => void;
        writeInt: (v: any) => void;
        writeUnsignedInt: (v: any) => void;
        _getDouble: (v: number) => number[];
        writeDouble: (v: any) => void;
        getResult: () => any;
        reset: () => void;
        writeStringWithoutType: (v: any) => void;
        stringByReference: (v: any) => any;
        objectByReference: (v: any) => number;
        traitsByReference: (v: any, alias: any) => any;
        writeAmfInt: (v: any) => void;
        writeDate: (v: any) => void;
        writeObject: (v: any) => void;
    ...
    class Reader {
        ...
        readUInt29: () => number;
        readFully: (buff: any, start: any, length: any) => void;
        readUTF: (length: any) => string;
        reset: () => void;
        readObject: () => any;
        readString: () => any;
        rememberString: (v: any) => void;
        getString: (v: any) => any;
        getObject: (v: any) => any;
        getTraits: (v: any) => any;
        rememberTraits: (v: any) => void;
        rememberObject: (v: any) => void;
        readTraits: (ref: any) => any;
    ...
    class Deserializer {
        private reader;
        constructor(data: any);
        readMessage: () => ActionMessage;
        readHeader: () => MessageHeader;
        readBody: () => MessageBody;
        readObject: () => any;
    }
}
declare module decoder {
    ...
    class ByteArray {
        ...
        uncompress(): void;
        static uncompress(inputBuffer: any): any;
    }
}
declare module decoder {
    class ZlibDecoder {
        decode(buffer: any, caller: any, callback: any, complete: any): void;
    }
    let zlibDecoder: ZlibDecoder;
    class AMFDecoder {
        decode(buffer: any): {};
    }
    let amfDecoder: AMFDecoder;
}
declare namespace decoder {
    class CByteArray extends egret.ByteArray {
        private Endian;
        ...
        private stringTable;
        private traitTable;
        constructor(_buffer?: ArrayBuffer | Uint8Array);
        readObject(): Object;
        private readAMF3Object();
        private clean();
        private readUInt29();
        private readStringAMF3();
        private readString(len);
